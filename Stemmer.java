...
class Stemmer
{  public HashMap<String, Vector<String>> stem = new HashMap<>();
	private char[] b;
   ...
   */
   ...
   //returns stemmed index to hashmap if one was previously serialized
   public  HashMap<String, Vector<String>> deser(String s ) {
